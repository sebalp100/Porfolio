    ...
    >
      ...
      <div className="lg:mr-20 sm:ml-24 sm:mr-4 text-center lg:text-start ml-4 mr-4 mb-4">
        ...
        <p>
          ...
          <br />
          <br />
          Since joining Microverse, I’ve created a number of website projects in
          JavaScript, React, and Rails with a focus on user experience and
          performance. All of these projects can be found in my portfolio.
        </p>
      </div>
      <div className="lg:hidden mt-10 sm:ml-14 mb-4 text-2xl xl:text-4xl flex gap-4">
        <FaJs />
        <SiRuby />
        <FaReact />
        <SiRedux />
