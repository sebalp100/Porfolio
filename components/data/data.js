...
const { SiRedux, SiRubyonrails, SiRuby, SiTailwindcss, SiFirebase, SiJavascript, SiHtml5, SiCss3, SiWebpack, SiJest } = require("react-icons/si");
...
const data = [
  ...
  },
  {
    ...
    icons: <><SiJavascript /><SiJest /> <SiWebpack /> </>,
    image: '/newmovies.png',
